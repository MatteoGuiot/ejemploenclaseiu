class Gestion_programa extends GestionEntidad {
  ...
  static comprobar_nuevo_fichero_programa() {
    ...
    if (validacionesatomicas.validarFileVacio(fichero)) {
    }
    else {
    ...
    if (validacionesatomicas.validarFileTam(fichero)) {
    }
    else {
    ...
    if (validacionesatomicas.validarFileFormato(fichero)) {
    }
    else {
  ...
  static comprobar_id_programa_SEARCH() {
    ...
    if (validacionesatomicas.digitos('id_programa')) {
      ...
      DOM_class.mostrardivmensajeserrordebajo('id_programa', 'KO_formato_id_programa');
      return false;
    }
  ...
  static comprobar_fichero_programa_SEARCH() {
    ...
    if (validacionesatomicas.soloAlfabetico('fichero_programa')) {
    }
    else {
      DOM_class.mostrardivmensajeserrordebajo('fichero_programa', 'KO_formato_fichero_programa');
      return false;
    }
  ...
  static comprobar_imagen_programa_SEARCH() {
    ...
    if (validacionesatomicas.soloAlfabetico('imagen_programa')) {
    }
    else {
      DOM_class.mostrardivmensajeserrordebajo('imagen_programa', 'KO_formato_imagen_programa');
      return false;
    }
  ...
  static recargarform() {
    ...
    document.getElementById("IU_form").innerHTML = `
      ...
      <div id="div_error_nueva_imagen_programa" class="errocampo"><a id="error_nueva_imagen_programa"></a></div>
      <br>
