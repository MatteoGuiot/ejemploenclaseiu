...
Array(
    ...
    Array('programa', 'tiempo_aplicacion_programa', 2, 'tamaño > 4', false, 'No puede tener mas de 4 caracteres'),
    Array('programa', 'tiempo_aplicacion_programa', 3, 'tamaño >= 1 || tamaño <= 4', true, 'Exito'),

    Array('programa', 'descrip_interp_programa', 1, 'tamaño menor que 100', false, 'La descripcion interp del programa debe tener como minimo cien digitos'),
    Array('programa', 'descrip_interp_programa', 2, 'tamaño mayor que 5000', false, 'La descripcion interp del programa debe tener como maximo cinco mil digitos'),
    Array('programa', 'descrip_interp_programa', 3, 'Algun caracter != Alfabetico con o sin acento, ñ, espacio ,signos de puntuacion o retornos de carro', false, 'La descrip interp del programa solo puede contener caracteres alfabeticos con acentos, ñ, espacios, signos de puntuacion y retornos de carro'),
    ...
    Array('publicacion', 'id_publicacion', 4,'tamaño mayor o igual a 1 && tamaño menor o igual a 6 && digitos', true, 'Exito'),

    Array('publicacion', 'titulo_publicacio', 1,'tamaño menor que 6', false, 'El titulo de publicacoin debe tener como minimo seis carateres'),
    Array('publicacion', 'titulo_publicacio', 2,'tamaño mayor que 80', false, 'El titulo de publicacion debe tener como maximo ochenta caracteres'),
    Array('publicacion', 'titulo_publicacio', 3,'Algun caracter != alfabeticos con acento, ñ o espacio', false, 'El titulo de publicacion solo puede contener caracteres alfabeticos con acento, ñ o espacio'),
    Array('publicacion', 'titulo_publicacio', 4,'tamaño mayor o igual a 6 && tamaño menor o igual a 80 && alfabeticos con acento, ñ o espacio', true, 'Exito'),
    ...
    Array('publicacion', 'fecha_publicacion', 2, 'digitos y "/" && foramto de la fecha igual a dd/mm/aaaa', true, 'Exito'),
