...
Array(
    ...
    Array('tipo_programa', 1, 'valor != "EVALUACIÓN", "INTERVENCIÓN" o "EVALUACIÓN E INTERVENCIÓN"', false, 'solo puedes elegir los valores "EVALUACIÓN", "INTERVENCIÓN" o "EVALUACIÓN E INTERVENCIÓN"'),
    Array('tipo_programa', 2, 'valor = "EVALUACIÓN", "INTERVENCIÓN" o "EVALUACIÓN E INTERVENCIÓN"', true, 'Exito'),

    Array('tiempo_aplicacion_programa', 1, 'tamaño < 1', false, 'Debe por lo menos tener un caracter'),
    Array('tiempo_aplicacion_programa', 1, 'tamaño > 4', false, 'No puede tener mas de 4 caracteres'),
    Array('tiempo_aplicacion_programa', 2, 'tamaño >= 1 || tamaño <= 4', true, 'Exito'),
    ...
    Array('fichero_programa', 4, 'formato distinito de pdf, doc o docx', false, 'El formato del fichero es erroneo, debe der pdf, doc o docx'),
    Array('fichero_programa', 5, 'tamaño del fichero es mas grande que 2000000 bytes', false, 'El fichero no puede ser mas grande que 2000000 bytes'),
    Array('fichero_programa', 6, 'tamaño mayor que 7 && tamaño menor o igual que 60 && Alfabetico sin acentos ni ñ ni espacios && formato igual a pdf, doc, docx && tamaño menor o igual a 2000000 bytes', true, 'Exito'),
    ...
    Array('imagen_programa', 4, 'formato distinto de jpg o jpeg', false, 'El formato es erroneo, debe ser jpg o jpeg'),
    Array('imagen_programa', 5, 'tamaño de la imagen es mas grande que 20000 bytes', false, 'El tamaño de la imagen es mas grande que 20000 bytes'),
    Array('imagen_programa', 6, 'tamaño mayor que 7 && tamaño menor o igual que 60 && Alfabetico sin acentos ni ñ ni espacios && formato igual a jpg o jpeg && tamaño igual o menor a 20000 bytes', true, 'Exito'),
